 ...
 * generated in the aplicacionproductorconsumidor package. 
...
public class ObjectFactory {
    ...
    private final static QName _Pagar_QNAME = new QName("http://consumidorproductor.me.org/", "Pagar");
    private final static QName _Comprar_QNAME = new QName("http://consumidorproductor.me.org/", "Comprar");
    private final static QName _ComprarResponse_QNAME = new QName("http://consumidorproductor.me.org/", "ComprarResponse");
    private final static QName _PagarResponse_QNAME = new QName("http://consumidorproductor.me.org/", "PagarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: aplicacionproductorconsumidor
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://consumidorproductor.me.org/", name = "Pagar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://consumidorproductor.me.org/", name = "Comprar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://consumidorproductor.me.org/", name = "ComprarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://consumidorproductor.me.org/", name = "PagarResponse")
